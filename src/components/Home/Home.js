...
const Home = () => {
    ...
    return (
        <>
            <div className='mx-5 md:mx-20 mt-10 grid grid-cols-1 md:grid-cols-2 gap-10'>
                <div className='pl-8 flex flex-col justify-center'>
                    ...
                    <button className='px-8 py-4 rounded-md bg-sky-200 text-blue-600 font-semibold w-40'>Live Demo</button>
                </div>
            ...
            <div className='grid justify-center mt-10 mb-8'>
                <button onClick={() => navigate('/reviews')} className='text-white font-semibold text-xl px-6 py-3 bg-blue-700 mx-20'>See All Reviews</button>
            </div>
        </>
    );
};
